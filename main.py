...
# generate origin country and transport data columns
...
# merge data, data_ship and data_air together into a single data frame
...
# check distribution of the CO2-scores (should be roughly even)
